...
export function Footer() {
  ...
  return (
    <footer className="bg-slate-50 text-slate-600 border-t border-slate-200 dark:bg-zinc-950 dark:text-zinc-400 dark:border-zinc-800 pt-16 pb-12 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top Branding & Architecture Highlights */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pb-12 border-b border-slate-200 dark:border-zinc-800/80 items-start">
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-950/60 dark:text-emerald-400 dark:border-emerald-800/50">
                <ShieldCheck className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                100% Client-Side Privacy
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200 dark:bg-blue-950/60 dark:text-blue-400 dark:border-blue-800/50">
          ...
          <div className="lg:col-span-8 bg-white dark:bg-zinc-900/80 rounded-2xl p-6 border border-slate-200 dark:border-zinc-800 shadow-sm dark:shadow-none">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-900 dark:text-zinc-300">
            ...
            <div className="flex flex-wrap gap-2">
              <Link to="/convert" className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/80 dark:bg-zinc-800/80 dark:hover:bg-zinc-700/80 dark:text-zinc-200 text-xs font-medium dark:border-zinc-700/60 transition-colors">
                Convert PDF
              </Link>
              <Link to="/extract" className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/80 dark:bg-zinc-800/80 dark:hover:bg-zinc-700/80 dark:text-zinc-200 text-xs font-medium dark:border-zinc-700/60 transition-colors">
                Data Extractor
              </Link>
              ...
              <Link to="/images" className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/80 dark:bg-zinc-800/80 dark:hover:bg-zinc-700/80 dark:text-zinc-200 text-xs font-medium dark:border-zinc-700/60 transition-colors">
                Image Converters
              </Link>
              <Link to="/security" className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200/80 dark:bg-zinc-800/80 dark:hover:bg-zinc-700/80 dark:text-zinc-200 text-xs font-medium dark:border-zinc-700/60 transition-colors">
                Security & Protect
              </Link>
              <Link to="/workspace" className="px-3 py-1.5 rounded-lg bg-violet-50 text-violet-700 border border-violet-200 hover:bg-violet-100 dark:bg-brand-950/70 dark:text-brand-300 dark:border-brand-800/60 dark:hover:bg-brand-900/70 text-xs font-semibold transition-colors">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 py-12 border-b border-slate-200 dark:border-zinc-800/80 text-sm">
          ...
          <div className="space-y-3">
            <h3 className="font-semibold text-slate-900 dark:text-white tracking-wide text-xs uppercase flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-violet-600 dark:bg-brand-500"></span>
              Convert
            </h3>
            <ul className="space-y-2 text-xs">
              <li><Link to="/pdf-to-word" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">PDF to Word</Link></li>
              ...
              <li><Link to="/pdf-to-jpg" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">PDF to JPG</Link></li>
              <li><Link to="/pdf-to-png" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">PDF to PNG</Link></li>
              <li><Link to="/pdf-to-webp" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">PDF to WebP</Link></li>
              ...
              <li><Link to="/pdf-to-powerpoint" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">PDF to PPT</Link></li>
              <li><Link to="/jpg-to-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">JPG to PDF</Link></li>
              <li><Link to="/images-to-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Images to PDF</Link></li>
              <li><Link to="/convert" className="text-violet-600 hover:text-violet-700 dark:text-brand-400 dark:hover:text-brand-300 font-medium">All Converters →</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li><Link to="/merge-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Merge PDF</Link></li>
              <li><Link to="/split-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Split PDF</Link></li>
              <li><Link to="/compress-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Compress PDF</Link></li>
              <li><Link to="/rotate-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Rotate PDF</Link></li>
              <li><Link to="/delete-pdf-pages" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Delete Pages</Link></li>
              <li><Link to="/extract-pdf-pages" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Extract Pages</Link></li>
              <li><Link to="/reorder-pdf-pages" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Reorder Pages</Link></li>
              <li><Link to="/watermark-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Watermark PDF</Link></li>
              <li><Link to="/add-page-numbers" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Page Numbers</Link></li>
              <li><Link to="/password-protect-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Protect PDF</Link></li>
              <li><Link to="/unlock-pdf" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Unlock PDF</Link></li>
              <li><Link to="/organize" className="text-violet-600 hover:text-violet-700 dark:text-brand-400 dark:hover:text-brand-300 font-medium">All Organize Tools →</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link to="/privacy" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link to="/terms" className="text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-white transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
        </div>

        {/* Privacy Promise Notice */}
        <div className="mt-8 bg-white dark:bg-zinc-900/90 border border-slate-200 dark:border-zinc-800 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm dark:shadow-none">
          <div className="flex items-start gap-3">
            <div className="p-2 rounded-xl bg-emerald-50 text-emerald-600 dark:bg-zinc-800 dark:text-emerald-400 mt-0.5">
          ...
          <div className="flex items-center gap-3 shrink-0 text-xs">
            <Link to="/privacy" className="text-slate-600 hover:text-slate-900 dark:text-zinc-300 dark:hover:text-white underline underline-offset-2 transition-colors">
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-zinc-900 flex flex-col sm:flex-row justify-between items-center text-xs text-slate-500 dark:text-zinc-500 gap-4">
