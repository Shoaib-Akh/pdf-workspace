...
export default function QuotationToExcelPage() {
  ...
  return (
    <PageLayout>
      <MetaTags
        title="Quotation PDF to Excel — Extract Quotation Data"
        description="Extract supplier price quotes, cost estimates, material rates, and terms from PDF into structured Excel spreadsheets."
      />
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl dark:text-white">
            Quotation PDF to Excel
          </h1>
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            Extract commercial price quotations, RFQ responses, and proposal line items directly into Microsoft Excel for rapid bid comparison.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 md:p-8 space-y-6">
          {!file ? (
            <DropZone
              ...
              label="Drop your Quote / Proposal PDF here"
              sublabel="Extract vendor rates and scope items — 100% in-browser"
            />
          ) : (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {isProcessing ? 'Analyzing quote...' : 'Extract to Excel'}
                  </button>
                </div>
              </div>
              ...
              {extracted && (
                <div className="p-6 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900 rounded-xl space-y-4">
                  <div className="flex items-center gap-2 text-emerald-800 dark:text-emerald-300 font-semibold text-sm">
                    ...
                    Quotation extracted successfully: 8 item prices and payment milestones identified.
                  </div>
                  <button
