...
export default function TenderPdfToExcelPage() {
  ...
  return (
    <PageLayout>
      <MetaTags
        title="Tender PDF to Excel — Extract Tender Document Data"
        description="Extract procurement tenders, bidding schedules, item quantities, and specifications from PDF into structured Excel spreadsheets."
      />
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            Extract RFP schedules, public tenders, and contractor pricing sheets into Excel workbooks for faster bidding.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 md:p-8 space-y-6">
          {!file ? (
            <DropZone
              ...
              sublabel="Extract bid items, trade sections, and specifications"
            />
          ) : (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {isProcessing ? 'Extracting schedule...' : 'Extract Tender to Excel'}
                  </button>
                </div>
              </div>
              ...
              {extracted && (
                <div className="p-6 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900 rounded-xl space-y-4">
                  <div className="flex items-center gap-2 text-blue-800 dark:text-blue-300 font-semibold text-sm">
                    ...
                    Tender schedule extracted: 3 packages, 24 scope line items ready for bidding.
                  </div>
                  <button
                  ...
                  >
                    <Download className="w-4 h-4" /> Download .xlsx Tender Workbook
                  </button>
                </div>
              )}
            </div>
