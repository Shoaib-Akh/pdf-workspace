...
import { Images, Download, Trash2, ArrowUp, ArrowDown, ShieldCheck, FileCheck } from 'lucide-react'
...
export default function ImagesToPdfPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      console.error(err)
      setErrorMsg('Failed to combine images into PDF. Please try again.')
    } finally {
  ...
  const handleDownload = () => {
    ...
    downloadBlob(resultBlob, 'combined-images.pdf')
  }

  return (
    <PageLayout>
      <MetaTags
        title="Images to PDF — Combine Multiple Images into PDF"
        description="Combine multiple images (JPG, PNG, WebP, GIF) into one PDF document. Reorder pages and customize orientation directly in your browser."
      />
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            Mix and merge multiple picture formats — JPG, PNG, WebP, SVG, and GIF — into a single unified PDF portfolio or document.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 md:p-8 space-y-6">
          <DropZone
            ...
            multiple={true}
            label="Drop your images here (JPG, PNG, WebP, GIF)"
            sublabel="Drag and drop multiple images to merge into a single PDF document"
          />
          ...
          {files.length > 0 && (
            <div className="space-y-6">
                ...
                {files.map((f, idx) => (
                  ...
                  >
                    <div className="flex items-center space-x-3 truncate">
                      ...
                      <Images className="w-5 h-5 text-blue-500 flex-shrink-0" />
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                >
                  {isConverting ? 'Merging into PDF...' : `Combine ${files.length} Images into One PDF`}
                </button>
