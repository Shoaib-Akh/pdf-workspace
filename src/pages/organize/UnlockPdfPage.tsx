...
import { Unlock, Download, CheckCircle2, Eye, EyeOff } from 'lucide-react'
  ...
  return (
    <PageLayout>
      <MetaTags
        ...
        description="Unlock password-protected PDF files and remove security restrictions. Decrypt PDFs instantly and safely in your web browser."
      />
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        <div className="text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            Strip passwords and edit restrictions from encrypted PDF documents that you have authorized access to, creating an unrestricted copy.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 md:p-8 space-y-6">
          {!file ? (
            <DropZone
              ...
              sublabel="In-memory decryption — your password never touches any remote server"
            />
          ) : (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 gap-4">
                <div className="flex items-center space-x-3 truncate">
                  ...
                  <div className="truncate">
                    ...
                    <p className="text-xs text-gray-500">{(file.size / (1024 * 1024)).toFixed(2)} MB • Encrypted document</p>
                  </div>
                </div>
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="Enter document password to decrypt"
              ...
              <div className="pt-2">
                ...
                >
                  {isProcessing ? 'Decrypting security stream...' : 'Unlock & Decrypt PDF'}
                </button>
              </div>
              ...
              {applied && (
                <div className="p-6 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-900 rounded-xl space-y-4">
                  <div className="flex items-center gap-2 text-green-800 dark:text-green-300 font-semibold text-sm">
                    ...
                    Document unlocked! Encryption removed permanently.
                  </div>
                  <button
                    onClick={() => alert('Downloading decrypted PDF...')}
